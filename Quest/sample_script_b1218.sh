...
#SBATCH --job-name=mimik_full           # Job name
...
#SBATCH --output=quest_b_logs/%j/output.log # Output file
#SBATCH --error=quest_b_logs/%j/error.log # Error Log file
...
cd /projects/b1218/Ahuja-lab/taeyoung/Mimik_modeling
